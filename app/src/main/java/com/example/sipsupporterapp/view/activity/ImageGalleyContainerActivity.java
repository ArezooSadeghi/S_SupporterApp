...
import com.example.sipsupporterapp.view.fragment.ImageGalleryFragment;

public class ImageGalleyContainerActivity extends SingleFragmentActivity {
    ...
    public Fragment createFragment() {
        ...
        return ImageGalleryFragment.newInstance(customerID, customerSupportID, customerProductID, customerPaymentID);
    }
    ...
    public static Intent newIntent(Context context, int customerID, int customerSupportID, int customerProductID, int customerPaymentID) {
        Intent intent = new Intent(context, ImageGalleyContainerActivity.class);
